...
<head>
    ...
    <title>About Callow Indonesia</title>
</head>
...
<body>
    ...
    <br><br>
    <div class="container">
        <h2 class="text-center font-weight-bold">About Callow Indonesia</h2><br><hr>
        <img src="<?= base_url('assets/img/about.jpg'); ?>" class="d-block w-50" alt="AboutUs" align="center" style="display: block; margin: auto;">
        <!-- Content -->
    </div>
    <br>
