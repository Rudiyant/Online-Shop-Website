...
<body>
    ...
    <br><br>
    <div class="container">
        <h2 class="text-center font-weight-bold">Profil Pengguna</h2>
        <br><hr>
        <div align="center">
            <?= $this->session->flashdata('editBerhasil'); ?>
        </div><br>
        <!-- Form -->
        <img src=<?= base_url('assets/img/profil.png'); ?> width="10%" height="10%" style="display: block; margin: auto;"> <br>
        <div align="center">
            <small>Nama</small><br>
            <p class="font-weight-bold"> <?= $this->session->userdata('nama'); ?> </p>
            <small>Alamat</small><br>
            <p class="font-weight-bold"> <?= $this->session->userdata('alamat'); ?> </p>
            <small>Nomor Hp</small><br>
            <p class="font-weight-bold"> <?= $this->session->userdata('no_hp'); ?> </p>
            <small>Username</small><br>
            <p class="font-weight-bold"> <?= $this->session->userdata('username'); ?> </p>
            <small>Password</small><br>
            <p class="font-weight-bold"> <?= $this->session->userdata('password'); ?> </p>
            <br>
            <?php $id_user = $this->session->userdata('id_user'); ?>
            <a href="<?= base_url('user/tampil_data_profil/') . $id_user; ?>" class="btn btn-warning btn-rounded">Edit Profil</a>
            <a href="<?= base_url('user/delete/') . $id_user; ?>" class="btn btn-danger btn-rounded">Hapus Akun</a>
            <br><br>
            <a href="<?= base_url('user/logout'); ?>" class="btn btn-danger btn-rounded">Logout</a>
        </div>
        <!-- Form -->
