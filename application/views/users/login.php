...
<body>
    ...
    <br><br>
    <div class="container">
        <h2 class="text-center font-weight-bold">Login Pelanggan</h2><br>
        <hr><br>
        <div class="container">
            <div class="row">
                <div class="col-sm">
                ...
                <div class="col-sm">
                    <div class="login-form">
                        <form action="<?= base_url('user/authenticate'); ?>" method="post">
                            ...
                            <hr>
                            <small>jika kamu sudah memiliki akun, silahkan login di sini.</small><br>
                            <br>
                            <form>
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control form-control-sm" type="password" placeholder="Password" name="password">
                                </div>
                ...
                <div class="col-sm">
                    ...
                    <hr>
                    <small>dengan membuat akun, Anda bisa mendapat lebih banyak keuntungan menarik.</small>
                    <br><br><br><br><br><br><br>
                    <a href="<?= base_url('user/registrasi'); ?>" class="btn btn-warning btn-block">Registrasi</a>
                </div>
                <div class="col-sm">
                </div>
            </div>
