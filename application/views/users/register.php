...
<body>
   ...
   <nav class="navbar navbar-expand-lg navbar-light bg-light">
    ...
    <br><br>
    <div class="container">
        <h2 class="text-center font-weight-bold">Buat Akun Pelanggan Baru</h2><br>
        <hr><br>
        <div class="container">
            <div class="row">
                <div class="col-sm">
                    ...
                    <div class="login-form">
                        <form action="<?= base_url('user/create'); ?>" method="post">
                            ...
                            <form>
                                ...
                                <div class="form-group">
                                    <small>Alamat</small>
                                    <textarea class="form-control form-control-sm"  rows="3" placeholder="Alamat" name="alamat"></textarea>
                                </div>
                                <div class="form-group">
                                    <small>Nomor HP</small>
                                    <input class="form-control form-control-sm" type="text" placeholder="Nomor HP" name="no_hp">
                                </div>
                                <div class="form-group">
