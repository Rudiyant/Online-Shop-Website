...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col">
                <h3 align="right"> Order&ensp;#&ensp;<?= $invoice['id_order'] ?></h3>
            </div>
        </div>
        <br>
        <hr>
        <div class="row">
            <div class="col">
                <small class="font-weight-bold"> Dikirim ke: </small><br>
                <small><?= $invoice['nama_pembeli'] ?></small><br>
                <small><?= $invoice['alamat_pembeli'] ?></small><br>
                <small><?= $invoice['no_hp_pembeli'] ?></small><br><br>
                <small class="font-weight-bold"> Metode Pengiriman: </small><br>
                <small><?= $invoice['metode_kirim'] ?></small>
            </div>
            <div class="col" align="right">
                <small class="font-weight-bold"> Tanggal Order: </small><br>
                <small><?= $tgl; ?></small><br><br>
                <small class="font-weight-bold"> Metode Pembayaran: </small><br>
                <small>Transfer Via <?= $invoice['metode_bayar'] ?></small><br><br>
                <small class="font-weight-bold" style="color:red"> Kode Pembayaran: </small><br>
                <small style="color:red">0298 3846 3728</small><br><br>
            </div>
        </div>
        <br>
        <hr>
        <p class="text-center font-weight-bold"> Ringkasan Pemesanan </p>
        ...
        <table class="table">
            ...
            <tbody>
                <tr>
                    <td><?= $invoice['nama_product'] ?></td>
                    <td><?= $invoice['ukuran'] ?></td>
                    <td><?= $invoice['warna'] ?></td>
                    <td>IDR.<?= $invoice['harga'] ?></td>
                </tr>
                <tr>
                    <td></td>
                    <td></td>
                ...
                <tr>
                    ...
                    <td class="font-weight-bold">IDR.<?= $invoice['harga'] ?></td>
                </tr>
            </tbody>
        </table>
        <hr><br>
        ...
        <div class="text-center">
            <a href="<?= base_url('order/tampil_order'); ?>" class="btn btn-dark">List Order</a>
            <a href="<?= base_url('order/tampil_laporan/'). $id_user; ?>" class="btn btn-warning">Riwayat Pembelian</a>
        </div>
    </div>
    </div>
    <!-- Content -->
