...
<body>
    ...
    <div class="container">
        <br><br>
        <h2 class="text-center font-weight-bold">List Order</h2><br><hr>
        <div class="text-center"> <?= $this->session->flashdata('cancelOrder'); ?> <?= $this->session->flashdata('editOrder'); ?> </div><br>
        <div class="container">
            <table class="table">
                ...
                <tbody>
                    <tr>
                        <?php foreach ($order as $row) : ?>
                            ...
                            <td align="center">
                                <a href="<?= base_url('order/tampil_data_order/') . $row['id_order']; ?>" class="btn btn-warning btn-sm btn-block">Edit Data</a>
                                <a href="<?= base_url('order/delete/') . $row['id_order']; ?>" class="btn btn-danger btn-sm btn-block">Cancel Order</a>
                                <a href="<?= base_url('order/check_out/') . $row['id_order']; ?>" class="btn btn-dark btn-sm btn-block">Check Out</a>
                            </td>
                    </tr>
                </tbody>
            <?php endforeach ?>
